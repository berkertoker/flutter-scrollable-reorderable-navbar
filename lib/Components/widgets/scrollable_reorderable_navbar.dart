...
import 'package:nav_bar/Components/widgets/delete_mode_item_listener.dart';
import 'package:nav_bar/Components/widgets/reorderable_item.dart';
      ...
      child: Container(    
        decoration: decoration ?? BoxDecoration(
          ...
          boxShadow: const [ BoxShadow(
                    color: Colors.white, offset: Offset(0, -1), blurRadius: 5,spreadRadius: 1,)
          ],
    ...
    return ReorderableListView.builder(
        ...
        itemBuilder: (context, index) {
          final shouldAddMargin =
              ...
              margin =
                  EdgeInsets.only(left: shouldAddMargin ? 0 : 0),
              item = _items[index];
